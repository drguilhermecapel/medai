...
class ValidationService:
    ...
    async def create_validation(
        ...
        validator_experience_years: int | None = None) -> Validation:
    ...
    async def submit_validation(
        ...
        validation_id: int,
        validator_id: int,
        validation_data: dict[str, Any]) -> Validation:
    ...
    def _can_validate(
        ...
        clinical_urgency: ClinicalUrgency) -> bool:
    ...
    async def validate_ecg_data(self, 
        """Validate ECG data."""
        try:
            return {
                "valid": True,
