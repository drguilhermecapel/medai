...
async def test_upload_ecg_file_validation_errors(client, auth_headers):
    ...
    with patch('app.api.v1.endpoints.ecg_analysis.UserService.get_current_user') as mock_user, \
         patch('app.api.v1.endpoints.ecg_analysis.ECGAnalysisService'):
...
async def test_upload_ecg_file_success_path(client, auth_headers):
    ...
    with patch('app.api.v1.endpoints.ecg_analysis.UserService.get_current_user') as mock_user, \
         ...
         patch('app.api.v1.endpoints.ecg_analysis.MLModelService'), \
         patch('app.api.v1.endpoints.ecg_analysis.ValidationService'), \
         patch('app.api.v1.endpoints.ecg_analysis.NotificationService'), \
