...
def test_ecg_tasks_realistic():
    ...
    from app.tasks.ecg_tasks import process_ecg_analysis, cleanup_old_analyses, generate_batch_reports
...
def test_basic_service_imports_realistic():
    ...
    from app.services.ai_diagnostic_service import AIDiagnosticService, DiagnosticConfidence
...
def test_comprehensive_schema_imports():
    ...
    from app.core.constants import ClinicalUrgency, UserRoles, AnalysisStatus
...
def test_comprehensive_api_endpoints():
    ...
    from app.api.v1.endpoints import auth, notifications, patients, validations, ecg_analysis
    from app.api.v1.endpoints import medical_records, ai
