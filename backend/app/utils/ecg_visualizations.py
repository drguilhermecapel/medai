...
class ECGVisualizer:
    ...
    def plot_standard_12_lead(self, signal: np.ndarray,
        ...
        for i, (ax, lead_name) in enumerate(zip(axes, self.lead_names, strict=False)):
    ...
    def plot_feature_importance(self, features: dict[str, float]) -> plt.Figure:
        ...
        for bar, value in zip(bars, importance_values, strict=False):
    ...
    def export_figure(self, fig: plt.Figure, format: str = 'png') -> bytes | str:
