...
import logging
from app.core.constants import SCPCategory, ClinicalUrgency
    ...
    async def _level2_category_classification(
        ...
        try:
            ...
            return {
                ...
                'features_used': ['heart_rate', 'rr_std', 'pr_interval', 'qrs_duration']
            }
    ...
    def _determine_clinical_urgency(self, level3_results: Dict[str, Any]) -> str:
        ...
        try:
            ...
            for diagnosis in diagnoses:
                ...
                if any(critical in diagnosis_name for critical in ['stemi', 'ventricular fibrillation', 'ventricular tachycardia']):
                    return ClinicalUrgency.CRITICAL.value
                elif scp_code in ['STEMI', 'VF', 'VT']:
                    return ClinicalUrgency.CRITICAL.value
                elif 'tachycardia' in diagnosis_name and diagnosis.get('confidence', 0) > 0.8:
                    return ClinicalUrgency.HIGH.value
                elif any(moderate in diagnosis_name for moderate in ['fibrillation', 'block', 'nstemi']):
