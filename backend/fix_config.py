...
class Settings(BaseSettings):
    ...
    def assemble_db_connection(cls, v: Optional[str], values: Dict[str, Any]) -> Any:
        ...
        # Se estiver em modo de teste, usa SQLite
        if values.get("TESTING", False) or os.getenv("TESTING", "").lower() == "true":
            return values.get("TEST_DATABASE_URL", "sqlite:///./test_medai.db")
        
        # Caso contrário, monta URL PostgreSQL
        return (
